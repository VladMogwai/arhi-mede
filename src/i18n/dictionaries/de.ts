...
export const de: Dictionary = {
  ...
  common: {
    ...
    romanianOnly: "Dieser Text ist derzeit nur auf Rumänisch verfügbar.",
  },
  categories: {
    "constructii-noi": "Neubauten",
    "consolidari-si-reabilitari-de-cladiri-existente": "Sanierung & Ertüchtigung",
    "amenajare-interioara": "Innenarchitektur",
    studii: "Studien",
  },
  home: {
    ...
    team: {
      title: "Das Team",
      caption: "Ein kleines Büro, in dem Architektinnen jedes Projekt von der ersten Skizze bis zur Baustelle begleiten.",
    },
    cta: {
  ...
  projects: {
    metaTitle: "Projekte",
    metaDescription: "Passivhäuser, sanierte Altbauten, Innenarchitektur und Stadtstudien von Arhi Mede Studio.",
    title: "Projekte",
    intro: "Passivhäuser, wiederbelebte Altbauten, Innenräume und Ideen für die Stadt.",
    filterAll: "Alle",
  },
  footer: {
