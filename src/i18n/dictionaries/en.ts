...
export const en: Dictionary = {
  ...
  common: {
    ...
    romanianOnly: "This text is currently available in Romanian only.",
  },
  categories: {
    "constructii-noi": "New buildings",
    "consolidari-si-reabilitari-de-cladiri-existente": "Retrofit & restoration",
    "amenajare-interioara": "Interiors",
    studii: "Studies",
  },
  home: {
    ...
    team: {
      title: "The team",
      caption: "A small practice where architects follow every project from the first sketch to the building site.",
    },
    cta: {
  ...
  projects: {
    metaTitle: "Projects",
    metaDescription: "Passive houses, restored old buildings, interiors and urban studies by Arhi Mede Studio.",
    title: "Projects",
    intro: "Passive houses, old buildings brought back to life, interiors and ideas for the city.",
    filterAll: "All",
  },
  footer: {
