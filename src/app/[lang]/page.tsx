...
export async function generateMetadata({ params }: PageProps<"/[lang]">): Promise<Metadata> {
  ...
  return { ...pageMetadata({ locale: lang, path: "", title: home.metaTitle, description: home.metaDescription }), title: { absolute: home.metaTitle } };
}
...
export default async function HomePage({ params }: PageProps<"/[lang]">) {
  ...
  return (
    <>
      ...
      <SiteHeader locale={lang} overHero />
    ...
    <section className="mx-3 mt-32 bg-sand px-5 py-16 sm:px-10 lg:mx-[5%] lg:px-[8%] lg:py-24">
      <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
        <div>
          ...
          <ArrowLink href={`/${locale}/projects/${featured.slug}`} className="mt-10">
            {common.viewProject}
          </ArrowLink>
        </div>
        <Photo
      ...
      <ArrowLink href={`/${locale}/projects`} className="mt-12">
        {common.allProjects}
      </ArrowLink>
    </section>
  );
