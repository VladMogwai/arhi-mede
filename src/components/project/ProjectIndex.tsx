              ...
              <div className="flex flex-col lg:col-span-5 lg:col-start-1">
                ...
                <div className="mt-10 flex items-end gap-6">
                  ...
                  <div>
                    ...
                    <ArrowLink href={localePath(locale, `/projects/${project.slug}`)} className="mt-6">
                      {labels.viewProject}
                    </ArrowLink>
                  </div>
                </div>
              </div>
              <Link href={localePath(locale, `/projects/${project.slug}`)} tabIndex={-1} className="lg:col-span-7">
                <Photo
